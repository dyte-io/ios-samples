...
SWIFT_CLASS("_TtC9DyteUiKit20DyteControlBarButton")
@interface DyteControlBarButton : UIButton
...
SWIFT_CLASS("_TtC9DyteUiKit14DyteAvatarView")
@interface DyteAvatarView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC9DyteUiKit10DyteButton")
@interface DyteButton : UIButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@property (nonatomic, getter=isSelected) BOOL selected;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit8DyteText")
@interface DyteText : UILabel
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC9DyteUiKit13DyteClockView")
@interface DyteClockView : DyteText
@end


SWIFT_CLASS("_TtC9DyteUiKit13DyteTabbarBar")
@interface DyteTabbarBar : UIView
...
SWIFT_CLASS("_TtC9DyteUiKit14DyteControlBar")
@interface DyteControlBar : DyteTabbarBar
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface DyteControlBarButton (SWIFT_EXTENSION(DyteUiKit))
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
...
SWIFT_CLASS("_TtC9DyteUiKit30DyteEndMeetingControlBarButton")
@interface DyteEndMeetingControlBarButton : DyteControlBarButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)onClickWithButton:(DyteEndMeetingControlBarButton * _Nonnull)button;
@end


SWIFT_CLASS("_TtC9DyteUiKit14DyteJoinButton")
@interface DyteJoinButton : DyteButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)onClickWithButton:(DyteJoinButton * _Nonnull)button;
@end


SWIFT_CLASS("_TtC9DyteUiKit21DyteMeetingControlBar")
@interface DyteMeetingControlBar : DyteControlBar
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9DyteUiKit21DyteMeetingHeaderView")
@interface DyteMeetingHeaderView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit18DyteMeetingNameTag")
@interface DyteMeetingNameTag : DyteNameTag
@end


SWIFT_CLASS("_TtC9DyteUiKit16DyteMeetingTitle")
@interface DyteMeetingTitle : DyteText
@end



SWIFT_CLASS("_TtC9DyteUiKit24DyteMoreButtonControlBar")
@interface DyteMoreButtonControlBar : DyteControlBarButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC9DyteUiKit17DyteNavigationBar")
@interface DyteNavigationBar : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC9DyteUiKit24DyteParticipantCountView")
...
- (void)onActiveSpeakerChangedParticipant:(DOSCDyteJoinedMeetingParticipant * _Nonnull)participant;
- (void)onAudioUpdateAudioEnabled:(BOOL)audioEnabled participant:(DOSCDyteMeetingParticipant * _Nonnull)participant;
- (void)onNoActiveSpeaker;
- (void)onParticipantJoinParticipant:(DOSCDyteJoinedMeetingParticipant * _Nonnull)participant;
- (void)onParticipantLeaveParticipant:(DOSCDyteJoinedMeetingParticipant * _Nonnull)participant;
- (void)onParticipantPinnedParticipant:(DOSCDyteJoinedMeetingParticipant * _Nonnull)participant;
- (void)onParticipantUnpinnedParticipant:(DOSCDyteJoinedMeetingParticipant * _Nonnull)participant;
- (void)onScreenSharesUpdated;
- (void)onVideoUpdateVideoEnabled:(BOOL)videoEnabled participant:(DOSCDyteMeetingParticipant * _Nonnull)participant;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit23DyteParticipantTileView")
@interface DyteParticipantTileView : DytePeerView
- (void)removeFromSuperview;
@end



SWIFT_CLASS("_TtC9DyteUiKit32DyteSwitchCameraButtonControlBar")
@interface DyteSwitchCameraButtonControlBar : DyteControlBarButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
- (void)onClickWithButton:(DyteControlBarButton * _Nonnull)button;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit13DyteTextField")
@interface DyteTextField : BaseAtomView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit21DyteWebinarControlBar")
@interface DyteWebinarControlBar : DyteControlBar
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit15MicToggleButton")
@interface MicToggleButton : DyteButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC9DyteUiKit20ScreenShareTabButton")
@interface ScreenShareTabButton : UIButton
@property (nonatomic, getter=isSelected) BOOL selected;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end
...
@interface ScreenShareTabButton (SWIFT_EXTENSION(DyteUiKit))
- (void)touchesBegan:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesEnded:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
- (void)touchesCancelled:(NSSet<UITouch *> * _Nonnull)touches withEvent:(UIEvent * _Nullable)event;
@end
...
@interface UITextView (SWIFT_EXTENSION(DyteUiKit)) <NSTextStorageDelegate>
...
SWIFT_CLASS("_TtC9DyteUiKit17VideoToggleButton")
@interface VideoToggleButton : DyteButton
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC9DyteUiKit16WebinarAlertView")
@interface WebinarAlertView : UIView
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
@end


SWIFT_CLASS("_TtC9DyteUiKit21WebinarViewController")
@interface WebinarViewController : MeetingViewController
@end
